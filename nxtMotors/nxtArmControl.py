...
def testInputMotor(tTest, direction, rotationSteps, PWMPin, InvPin, enablePin, input1, input2):
...
while userInput.lower() != "q":
    userInput = input("Next step [Init/Start/Go/Up/Down/Rotate/Quit] : ")
    if userInput.lower() == "i" : #per initialization only
        testInputMotor(1, direction=-1, rotationSteps=50, 
        ...
        testInputMotor(1,direction=-1, rotationSteps=310, 
                        PWMPin=Mot2_PWM_Pin, InvPin=Mot2_Inv_Pin, enablePin=Mot2_Enable_Pin, 
                        input1=Mot2_decoderIN1_Pin,input2=Mot2_decoderIN2_Pin)

    if userInput.lower() == "g" : # da START A ROTATE : "Go" : "G"
        testInputMotor(1, direction=+1, rotationSteps=300, 
                        PWMPin=Mot2_PWM_Pin, InvPin=Mot2_Inv_Pin, enablePin=Mot2_Enable_Pin, 
                        input1=Mot2_decoderIN1_Pin,input2=Mot2_decoderIN2_Pin)

    elif userInput.lower() == "u" : # from ROTATE to UP : "Up" : "U"     
        testInputMotor(1, direction=-1, rotationSteps=200, 
                        PWMPin=Mot2_PWM_Pin, InvPin=Mot2_Inv_Pin, enablePin=Mot2_Enable_Pin, 
                        input1=Mot2_decoderIN1_Pin,input2=Mot2_decoderIN2_Pin)
        ...
        testInputMotor(1, direction=+1, rotationSteps=150, 
                        PWMPin=Mot2_PWM_Pin, InvPin=Mot2_Inv_Pin, enablePin=Mot2_Enable_Pin, 
                        input1=Mot2_decoderIN1_Pin,input2=Mot2_decoderIN2_Pin)
        time.sleep(0.25)
        testInputMotor(1, direction=-1, rotationSteps=300, 
                        ...
                        input1=Mot2_decoderIN1_Pin,input2=Mot2_decoderIN2_Pin)
        time.sleep(0.1)
        testInputMotor(1, direction=+1, rotationSteps=125, 
                        PWMPin=Mot2_PWM_Pin, InvPin=Mot2_Inv_Pin, enablePin=Mot2_Enable_Pin, 
                        input1=Mot2_decoderIN1_Pin,input2=Mot2_decoderIN2_Pin)
    else:
        pass
